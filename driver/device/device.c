...
static int setup_chdevs_resources(void)
{
	...
	err = alloc_chrdev_region(&dev, module_major, MODULE_MINORS, MODULE_DEVICE_NAME);
	if (err < 0)
	{
	...
	module_class = class_create(THIS_MODULE, MODULE_DEVICE_NAME);
